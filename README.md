...
| [Injectics](./medium/Injectics/report.md) | THM | Linux | Profile Input SSTI → Hardened Twig Sandbox Enumeration → `sort` Filter Callback Bypass → RCE (www-data) | 2026-03-14 |
### Hard
